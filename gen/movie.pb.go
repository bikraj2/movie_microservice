...
type GetMetadataReqeust struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *GetMetadataReqeust) Reset() {
	*x = GetMetadataReqeust{}
	mi := &file_movie_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetMetadataReqeust) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetMetadataReqeust) ProtoMessage() {}

func (x *GetMetadataReqeust) ProtoReflect() protoreflect.Message {
	mi := &file_movie_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetMetadataReqeust.ProtoReflect.Descriptor instead.
func (*GetMetadataReqeust) Descriptor() ([]byte, []int) {
	return file_movie_proto_rawDescGZIP(), []int{2}
}

func (x *GetMetadataReqeust) GetMovieId() string {
	if x != nil {
		return x.MovieId
	}
	return ""
...
var file_movie_proto_rawDesc = string([]byte{
	...
	0x47, 0x65, 0x74, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x52, 0x65, 0x71, 0x65, 0x75,
	...
	0x74, 0x61, 0x69, 0x6c, 0x73, 0x32, 0x83, 0x01, 0x0a, 0x0f, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61,
	...
	,
	...
	0x32, 0x0a, 0x09, 0x50, 0x75, 0x74, 0x52, 0x61, 0x74, 0x69, 0x6e, 0x67, 0x12, 0x11, 0x2e, 0x50,
	0x75, 0x74, 0x52, 0x61, 0x74, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	0x12, 0x2e, 0x50, 0x75, 0x74, 0x52, 0x61, 0x74, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x73, 0x70, 0x6f,
...
var file_movie_proto_goTypes = []any{
	...
	(*GetMetadataReqeust)(nil),          // 2: GetMetadataReqeust
...
var file_movie_proto_depIdxs = []int32{
	...
	2,  // 4: MetadataService.GetMetadata:input_type -> GetMetadataReqeust
	8,  // 5: MetadataService.PutMetadata:input_type -> PutRatingRequest
