...
func (c *metadataServiceClient) GetMetadata(ctx context.Context, in *GetMetadataReqeust, opts ...grpc.CallOption) (*GetMetadataResponse, error) {
...
func _MetadataService_GetMetadata_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MetadataServiceServer).GetMetadata(ctx, req.(*GetMetadataReqeust))
	}
